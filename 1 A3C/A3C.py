...
class ACNet(object):
    ...
    def _build_net(self, scope):  # 网络定义
        ...
        with tf.variable_scope('critic'):
            l_c1 = tf.layers.dense(self.s, units_num, tf.nn.relu6, kernel_initializer=w_init, name='lc1')
            l_c = tf.layers.dense(l_c1, units_num, tf.nn.relu6, kernel_initializer=w_init, name='lc2')
